package com.test.movie.response;
...
public class Response implements Serializable {
    ...
    // 封装(声明)常见的错误类型
    // 1001, 用户名或者密码错误
    public static final Response SPIDER_WRONG = new Response("1001", "something wrong happened in the spider");
    // 1002, 电话号码或者邮件地址没写
    public static final Response TRANSPORT_WRONG = new Response("1002", "transport message failed");
