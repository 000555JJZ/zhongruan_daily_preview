...
def get_headers():
    ...
    # Safari/537.36', 'Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101 Firefox/60.0', 'Mozilla/5.0 (X11;
    # U; Linux x86_64; zh-CN; rv:1.9.2.10) Gecko/20100922 Ubuntu/10.10 (maverick) Firefox/3.6.10', 'Mozilla/5.0 (
    # X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36
    # OPR/60.0.3255.83' ]
...
if __name__ == '__main__':
    ...
    # file.truncate()
    urls = ['https://api.bilibili.com/x/web-interface/archive/stat?aid={}'.format(num) for num in range(192063, 220000)]
    for url in urls:
        get_single_data(url)
    file.close()
