...
if __name__ == '__main__':
    urls = ['https://www.bilibili.com/v/douga/other/?spm_id_from=333' \
            '.6.b_7375626e6176.7#/all/click/0/{}/2020-07-16,2020-07-23'.format(number) for number in range(1, 52)]
    for url in urls:
        single_page_spider(url)
    file = open('../urls/urls_cartoon_6.json', 'w', encoding='utf-8')
    try:
