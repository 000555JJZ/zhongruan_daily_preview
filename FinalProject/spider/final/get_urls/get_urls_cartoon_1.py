...
if __name__ == '__main__':
    file = open('../urls/urls_cartoon_1.json', 'a', encoding='utf-8')
    urls = ['https://www.bilibili.com/v/douga/mad/?spm_id_from=333.5.b_7375626e6176' \
            '.2#/all/click/0/{}/2020-07-16,2020-07-23'.format(number) for number in range(1, 52)]
    for url in urls:
