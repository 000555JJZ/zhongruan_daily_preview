...
public class ChartInfoRelation implements org.apache.thrift.TBase<ChartInfoRelation, ChartInfoRelation._Fields>, java.io.Serializable, Cloneable, Comparable<ChartInfoRelation> {
  ...
  public ChartInfoRelation setValue(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> value) {
    this.value = value;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.value = new java.util.ArrayList<java.lang.String>(_list43.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChartInfoRelation struct) throws org.apache.thrift.TException {
      ...
      if (struct.value != null) {
        oprot.writeFieldBegin(VALUE_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter56 : struct.value)
          {
      ...
      if (struct.isSetValue()) {
        {
          ...
          for (java.lang.String _iter61 : struct.value)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.value = new java.util.ArrayList<java.lang.String>(_list68.size);
